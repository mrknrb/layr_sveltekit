...
export class MrkLib {
    ...
    static shadowForOverlappingNodesOnce(parentDiv: HTMLDivElement) {
      ...
      //@ts-ignore
        ...
        YOverLappingParok.forEach((elementPar, index) => {
            if (MrkLib.getElementIndex(elementPar.egyikElement) > MrkLib.getElementIndex(elementPar.masikElement)) {
    ...
    static forEachInObject<objectsType>(object: object | undefined, forEachCallback: (object: objectsType, key: string) => any) {
...
// @ts-ignore
    ...
    static splitArrayDataByValue<DataType>(arrayOfData: DataType[], checkFunction: (data: DataType) => boolean) {
    ...
    static createMissingFields<objectType extends object>(objectToCheck: any, objectBase: objectType) {
